        ...
        <div class="header-holder">         
            ...
            <div class="nav-holder">
                <div class="container">
                    ...
                    <div id="primary-toggle-button"><?php esc_html_e( 'MENU', 'tour-operator' );?><i class="fa fa-bars"></i></div>
...
function tour_operator_customizer_theme_info( $wp_customize ){
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View demo', 'tour-operator' ) . ': </label><a href="' . esc_url( 'https://demo.rarathemes.com/tour-operator/' ) . '" target="_blank">' . __( 'here', 'tour-operator' ) . '</a></span>';
